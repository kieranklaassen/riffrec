...
var LiveSession = class _LiveSession {
  ...
  recordUnit(input) {
    ...
    const firstAnchorT = _nullishCoalesce(_optionalChain([input, 'access', _199 => _199.anchors, 'access', _200 => _200[0], 'optionalAccess', _201 => _201.t]), () => ( this.elapsed()));
    const unit = {
      id,
      ...
      evidence: {
        frame_ids: _nullishCoalesce(_optionalChain([input, 'access', _202 => _202.evidence, 'optionalAccess', _203 => _203.frame_ids]), () => ( [])),
        annotation_ids: _nullishCoalesce(_optionalChain([input, 'access', _204 => _204.evidence, 'optionalAccess', _205 => _205.annotation_ids]), () => ( [])),
        transcript_span: _nullishCoalesce(_optionalChain([input, 'access', _206 => _206.evidence, 'optionalAccess', _207 => _207.transcript_span]), () => ( { t_start: firstAnchorT, t_end: this.elapsed() })),
        ..._optionalChain([input, 'access', _208 => _208.evidence, 'optionalAccess', _209 => _209.telemetry_window]) ? { telemetry_window: input.evidence.telemetry_window } : {},
        ..._optionalChain([input, 'access', _210 => _210.evidence, 'optionalAccess', _211 => _211.audio_clip_id]) ? { audio_clip_id: input.evidence.audio_clip_id } : {}
      },
      status: "initial"
    };
    this.units.add(unit);
  ...
  snapshot() {
    return {
      ...
      queueLength: _nullishCoalesce(_optionalChain([this, 'access', _212 => _212.queue, 'optionalAccess', _213 => _213.length]), () => ( 0)),
  ...
  async restoreFrameBytes(onError) {
    for (const entry of _nullishCoalesce(_optionalChain([this, 'access', _214 => _214.queue, 'optionalAccess', _215 => _215.all, 'call', _216 => _216()]), () => ( []))) {
    ...
    await Promise.all(
      this.frames.filter((frame) => !frame.dropped && !this.frameBytes.has(frame.id)).map(async (frame) => {
        try {
          ...
          _optionalChain([onError, 'optionalCall', _217 => _217(error)]);
        }
      })
    );
  }
  emit(type, payload) {
    ...
    if (this.client && this.phase === "running") {
      ...
      _optionalChain([this, 'access', _218 => _218.queue, 'optionalAccess', _219 => _219.enqueue, 'call', _220 => _220(envelope)]);
    }
    this.persist();
    this.notify();
    return envelope;
  ...
  frameKind(frameId) {
    return _nullishCoalesce(_optionalChain([this, 'access', _221 => _221.frames, 'access', _222 => _222.find, 'call', _223 => _223((frame) => frame.id === frameId), 'optionalAccess', _224 => _224.kind]), () => ( null));
  }
  ...
  handleEnded(reason) {
    ...
    this.streamStatus = "ended";
    this.emitter.dispose();
    _optionalChain([this, 'access', _225 => _225.client, 'optionalAccess', _226 => _226.close, 'call', _227 => _227()]);
    this.detachPageHide();
    for (const waiter of this.ackWaiters.splice(0)) waiter.resolve(false);
    this.clearStorage();
...
function describeClick(event, route) {
  const { element } = event;
  const label = _optionalChain([element, 'access', _228 => _228.ariaLabel, 'optionalAccess', _229 => _229.trim, 'call', _230 => _230()]) || _optionalChain([element, 'access', _231 => _231.name, 'optionalAccess', _232 => _232.trim, 'call', _233 => _233()]) || element.tag;
  const text = _optionalChain([element, 'access', _234 => _234.text, 'optionalAccess', _235 => _235.trim, 'call', _236 => _236()]) ? truncate2(element.text, CLICK_TEXT_MAX_CHARS) : "";
  const parts = [label];
...
function defaultGetUserMedia(constraints) {
  if (typeof navigator === "undefined" || !_optionalChain([navigator, 'access', _237 => _237.mediaDevices, 'optionalAccess', _238 => _238.getUserMedia])) {
...
var LiveRuntime = class {
  constructor(options) {
    ...
    this.annotation = (annotation) => {
      ...
      _optionalChain([active, 'access', _239 => _239.interviewer, 'optionalAccess', _240 => _240.announceDrawing, 'call', _241 => _241({
  ...
  retryVoice() {
    void _optionalChain([this, 'access', _242 => _242.active, 'optionalAccess', _243 => _243.interviewer, 'optionalAccess', _244 => _244.retryVoice, 'call', _245 => _245(), 'access', _246 => _246.catch, 'call', _247 => _247((error) => this.callbacks.onError(toError(error)))]);
  }
  setMuted(muted) {
    const active = this.active;
    if (_optionalChain([active, 'optionalAccess', _248 => _248.interviewer])) {
      active.interviewer.setMuted(muted);
      return;
    }
    _optionalChain([active, 'optionalAccess', _249 => _249.microphone, 'optionalAccess', _250 => _250.setMuted, 'call', _251 => _251(muted)]);
  ...
  setPaused(paused) {
    this.paused = paused;
    if (paused) _optionalChain([this, 'access', _252 => _252.active, 'optionalAccess', _253 => _253.evidence, 'access', _254 => _254.pause, 'call', _255 => _255()]);
    else _optionalChain([this, 'access', _256 => _256.active, 'optionalAccess', _257 => _257.evidence, 'access', _258 => _258.resume, 'call', _259 => _259()]);
  }
  ...
  suspend() {
    ...
    if (active) {
      ...
      _optionalChain([active, 'access', _260 => _260.microphone, 'optionalAccess', _261 => _261.stop, 'call', _262 => _262()]);
    }
  ...
  startCaptures(micStream, { share = true } = {}) {
    ...
    const screen = new (0, _chunkVTWYAC7Zcjs.ScreenCapture)(this.capture.displayMedia, this.capture.displayMediaVideo, {
      ...
      onStreamEnded: () => {
        ...
        if (_optionalChain([this, 'access', _263 => _263.active, 'optionalAccess', _264 => _264.screen]) === screen && session.status !== "ended") this.callbacks.onReshareNeeded(true);
      },
      onError: (error) => this.callbacks.onError(toError(error))
    });
  ...
  releaseCaptures(active) {
    ...
    _optionalChain([active, 'access', _265 => _265.interviewer, 'optionalAccess', _266 => _266.stop, 'call', _267 => _267()]);
    _optionalChain([active, 'access', _268 => _268.connector, 'optionalAccess', _269 => _269.dispose, 'call', _270 => _270()]);
  ...
  async doStop() {
    ...
    let voiceBlob = null;
    const events = _nullishCoalesce(_optionalChain([active, 'optionalAccess', _271 => _271.events]), () => ( []));
    if (active) {
      this.releaseCaptures(active);
      ...
      _optionalChain([active, 'access', _272 => _272.microphone, 'optionalAccess', _273 => _273.stop, 'call', _274 => _274()]);
    }
...
function defaultGetUserMedia2(constraints) {
  if (typeof navigator === "undefined" || !_optionalChain([navigator, 'access', _275 => _275.mediaDevices, 'optionalAccess', _276 => _276.getUserMedia])) {
...
function ConsentDialog({
  ...
  _react.useEffect.call(void 0, () => {
    _optionalChain([dialogRef, 'access', _277 => _277.current, 'optionalAccess', _278 => _278.focus, 'call', _279 => _279()]);
  }, []);
...
function needsOpenAIKey(reason) {
  if (_optionalChain([reason, 'optionalAccess', _280 => _280.kind]) !== "refused") return false;
...
function LiveOverlay({
  ...
  _react.useEffect.call(void 0, () => {
    ...
    setEndedReason(null);
    setDismissed(false);
    if (uncontrolledPausedRef.current) _optionalChain([onPauseChangeRef, 'access', _282 => _282.current, 'optionalCall', _283 => _283(false)]);
  ...
  const handleConsent = _react.useCallback.call(void 0, 
    (result) => {
      ...
      session.start();
      _optionalChain([onConsent, 'optionalCall', _284 => _284(result)]);
    },
    [session, onConsent]
  );
  const handleDecline = _react.useCallback.call(void 0, () => {
    session.declineConsent();
    _optionalChain([onDecline, 'optionalCall', _285 => _285()]);
  }, [session, onDecline]);
  ...
  const togglePause = _react.useCallback.call(void 0, () => {
    ...
    _optionalChain([onPauseChangeRef, 'access', _286 => _286.current, 'optionalCall', _287 => _287(next)]);
  }, [paused, controlledPaused]);
  ...
  const handleConfirmations = _react.useCallback.call(void 0, 
    async (confirmations) => {
      ...
      try {
        ...
        _optionalChain([onFinished, 'optionalCall', _288 => _288(result)]);
      } finally {
  ...
  onKey.current = (event) => {
    ...
    if (snapshot.phase === "ended") {
      ...
      if (key === "enter") act = () => _optionalChain([panelRef, 'access', _289 => _289.current, 'optionalAccess', _290 => _290.querySelector, 'call', _291 => _291("[data-riffrec-confirm-finish]"), 'optionalAccess', _292 => _292.click, 'call', _293 => _293()]);
    } else if (running) {
      const keys = {
        v: () => setTool("cursor"),
    ...
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { ...{ [OVERLAY_ATTRIBUTE]: "" }, "data-riffrec-live-overlay": "ended", style: { ...endedWrapStyle, zIndex: zIndex + 1 }, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        EndedCard,
        {
          ...
          next: onStartNext ? _optionalChain([nextSession, 'optionalAccess', _294 => _294.state]) : null,
          onStartNext
        }
      ),
  ...
  const agentState = _nullishCoalesce(_optionalChain([snapshot, 'access', _295 => _295.agent, 'optionalAccess', _296 => _296.state]), () => ( (queued > 0 ? "working" : null)));
          ...
          "div",
          {
            ...
            children: [
              ...
              view === "board" ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
                ...
                agentState ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, AgentStatus, { state: agentState, since: _nullishCoalesce(_optionalChain([snapshot, 'access', _297 => _297.agent, 'optionalAccess', _298 => _298.since]), () => ( null)), working, queued }) : null,
                ...
                /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: bodyStyle, children: [
                  ...
                  snapshot.status === "buffering" || _optionalChain([snapshot, 'access', _299 => _299.voiceUnavailable, 'optionalAccess', _300 => _300.kind]) === "exhausted" ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
                    "p",
                    {
                      role: "alert",
...
function LiveMount({
  ...
  const handlePause = _react.useCallback.call(void 0, (paused) => _optionalChain([runtimeRef, 'access', _301 => _301.current, 'optionalAccess', _302 => _302.setPaused, 'call', _303 => _303(paused)]), []);
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      ...
      {
        session,
        profile: _optionalChain([runtime, 'optionalAccess', _304 => _304.consentProfile]),
        endpointOwner: config.endpointOwner,
        drawShortcut: config.drawShortcut,
        getUserMedia,
        onConsent: (result) => _optionalChain([runtime, 'optionalAccess', _305 => _305.consent, 'call', _306 => _306(result)]),
        onAnnotation: _optionalChain([runtime, 'optionalAccess', _307 => _307.annotation]),
        onFinished: (result) => _optionalChain([runtime, 'optionalAccess', _308 => _308.finished, 'call', _309 => _309(result)]),
        onPauseChange: handlePause,
        onRetryVoice: () => _optionalChain([runtime, 'optionalAccess', _310 => _310.retryVoice, 'call', _311 => _311()]),
        nextSession,
        onStartNext: onStart
      }
    ),
...
//# sourceMappingURL=LiveOverlay-GINH6EOT.cjs.map