...
import { useCallback as useCallback3, useEffect as useEffect5, useRef as useRef6, useState as useState8 } from "react";
...
import { useCallback as useCallback2, useEffect as useEffect4, useMemo, useRef as useRef5, useState as useState7 } from "react";
...
function ConsentDialog({
  ...
  const actions = useRef3({ next, back, setMode, setVoiceOn, setFramesOn, setAgreed, step });
    ...
    "div",
    {
      ...
      children: [
        ...
        collapsed && view === "board" ? /* @__PURE__ */ jsxs12("div", { "data-riffrec-live-pill": "", style: { ...pillStyle2, zIndex: zIndex + 1 }, children: [
          ...
          running ? /* @__PURE__ */ jsx12(SendControl, { onSend: handleSend, heldCount: held, compact: true }) : null,
          /* @__PURE__ */ jsx12(
            "button",
            {
              type: "button",
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs12("div", { style: headerStyle, children: [
                /* @__PURE__ */ jsxs12("span", { style: { display: "flex", alignItems: "baseline", gap: 10, minWidth: 0 }, children: [
                  /* @__PURE__ */ jsx12(Wordmark, {}),
                  /* @__PURE__ */ jsxs12(
                    "span",
                    {
              ...
              view === "board" ? /* @__PURE__ */ jsxs12(Fragment, { children: [
                /* @__PURE__ */ jsxs12("div", { "data-riffrec-voice": "", style: voiceRowStyle, children: [
                  micButton(),
                  /* @__PURE__ */ jsxs12(
                    "button",
                    {
                      ...
                      children: [
                        paused ? "Resume" : "Pause",
                        /* @__PURE__ */ jsx12(Kbd, { dark: paused, children: "P" })
                      ]
                    }
                  )
                ] }),
                ...
                /* @__PURE__ */ jsxs12("div", { style: footerStyle, children: [
                  ...
                  /* @__PURE__ */ jsxs12("span", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
                    /* @__PURE__ */ jsx12("span", { "data-riffrec-live-held": "", style: { fontSize: 11, color: "#98a2b3" }, children: held > 0 ? `${held} held` : "Nothing held" }),
                    /* @__PURE__ */ jsx12(SendControl, { onSend: handleSend, heldCount: held, disabled: !running, compact: true }),
                    /* @__PURE__ */ jsx12(Kbd, { children: "S" })
                  ] })
                ] })
...
//# sourceMappingURL=LiveOverlay-LAIFFKPH.js.map